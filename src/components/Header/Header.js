...
const Header = ({ t }) => (
  <Container>
    ...
    <Div2 style={{ marginBottom: 10, alignItems: 'center' }}>
      <li>
        <Link href='#projects'>
    ...
    <Div3 style={{ marginBottom: 18, alignItems: 'center' }}>
            ...
            {languages.map(({ code, name, country_code }) => (
              <li key={country_code}>
                <button
                  ...
                  <span style={{ fontSize: 15, marginTop: 10 }}>{name}</span>
                </button>
              </li>
            ))}
          </ul>
